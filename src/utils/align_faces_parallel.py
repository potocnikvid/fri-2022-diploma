...
SHAPE_PREDICTOR_PATH = os.getenv('ROOT') + "/src/.cache/shape_predictior/shape_predictor_68_face_landmarks.dat"
...
def align_faces(root_path, num_threads=1):
	...
	for file in os.listdir(root_path):
		if os.path.isdir(os.path.join(root_path, file)) or os.path.splitext(file)[1] not in ['.jpg', '.png']:
			continue
...
if __name__ == '__main__':
	args = parse_args()
	align_faces(args.root_path, args.num_threads)
